 ...
 *         &lt;element name="numeroScontrino" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="descrizioneOperazione" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UsaGiftCard")
public class UsaGiftCard {
    ...
    @XmlElementRef(name = "numeroScontrino", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numeroScontrino;
    @XmlElementRef(name = "descrizioneOperazione", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> descrizioneOperazione;
    ...
    /**
     * Recupera il valore della proprietà numeroScontrino.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getNumeroScontrino() {
        return numeroScontrino;
    }

    /**
     * Imposta il valore della proprietà numeroScontrino.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNumeroScontrino(JAXBElement<String> value) {
        this.numeroScontrino = value;
    }

    /**
     * Recupera il valore della proprietà descrizioneOperazione.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getDescrizioneOperazione() {
        return descrizioneOperazione;
    }

    /**
     * Imposta il valore della proprietà descrizioneOperazione.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setDescrizioneOperazione(JAXBElement<String> value) {
        this.descrizioneOperazione = value;
    }
